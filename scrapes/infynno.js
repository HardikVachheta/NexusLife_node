/**
 * This is a Node.js server that acts as a proxy to scrape job data.
 * You need to have Node.js, Express, and Puppeteer installed.
 *
 * To set up and run this server:
 * 1. Make sure Node.js is installed.
 * 2. Create a new folder for this project.
 * 3. Inside the folder, run these commands in your terminal:
 * npm init -y
 * npm install express puppeteer cors
 * 4. Save this code as `server.js` in the same folder.
...
// Enable CORS for all routes so your React app can make requests
app.use(cors());

/**
 * Scrapes job details from the Infynno website.
 */
...
// API endpoint to get job details based on company name.
